            ...
            <div class="row bg-color-ash p-3 event-highlight">
              <div class="col-12 col-sm-6 d-flex justify-content-center">
                <div class="row">
                  ...
                  <div class="col-11">
                    <h3>08808067765</h3>
                    <p class="color-light-blue">Office Line 1</p>
                  </div>
                </div>
              </div>
              <div class="col-12 col-sm-6 d-flex justify-content-center">
                <div class="row">
                  ...
                  <div class="col-11">
                    <h3>08808067765</h3>
                    <p class="color-light-blue">Office Line 2</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <form>
                  ...
                  <div class="row">
                    <div class="col">
                      ...
                      <textarea class="form-control no-br mb-4 no-b" rows="3" placeholder="Message"></textarea>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-12 col-sm-3">
                      <input type="submit" class="form-control no-br btn-gf color-white mb-4" placeholder="First name">
                    </div>
                  </div>
                </form>
              </div>
